// False positive: this module is itself only reachable via `await import()`
// in the brand-guidelines API route and renders server-side; nothing here
// ships to the client bundle, so an eager top-level import is correct.
...
<Page size="A4" style={styles.coverPage}>
  <View style={styles.coverContent}>
    ...
    <Text style={styles.coverDate}>
      Version 2.0 | {currentYear} | EPFL Engineering Alumni
    </Text>
  </View>
</Page>
);
...
<Page size="A4" style={styles.page}>
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Accent Usage" value="Swiss Red #D03232 used surgically." />
...
<Page size="A4" style={styles.page}>
  ...
  <View style={styles.colorGrid}>
    <ColorCard color={colors.brand} name="Swiss Red" hex="#D03232" token="--color-brand" />
...
<Page size="A4" style={styles.page}>
  ...
  <View style={styles.card}>
    <Text style={styles.specimenTitle}>
      CLASHWARE
    </Text>
    <Text style={styles.specimenLine}>
      ABCDEFGHIJKLMNOPQRSTUVWXYZ
    </Text>
    <Text style={styles.specimenLineLast}>
  ...
  <View style={styles.card}>
    <Text style={styles.monoSampleHeader}>
      [SYS.ONLINE] // MODULE: 01
    </Text>
    <Text style={styles.monoSampleLine}>
      PRODUCTS | ABOUT | CONTACT | GET IN TOUCH
    </Text>
    <Text style={styles.monoSampleLineLast}>
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Overline" value="text-xs / Geist Mono / uppercase / tracking-widest / #D03232" />
...
<Page size="A4" style={styles.page}>
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Primary" value="bg #D03232, text #FAFAFA, font-mono uppercase" />
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Hover" value="bg #18181B, left accent line #D03232" />
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Active State" value="2px bottom line in #D03232, scale-x from left" />
...
<Page size="A4" style={styles.page}>
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Colors" value="#D03232, #F97316, #FF3C00, #991B1B" />
  </View>
  ...
  <View style={styles.card}>
    ...
    <SpecRow label="Card Hover" value="bg shift to #18181B, left accent turns #D03232" />
  ...
  <View style={styles.card}>
    <View style={styles.gridRow}>
      ...
      <View style={styles.gridCol}>
        ...
        <Text style={styles.voiceBodyMono}>
